        ...
        <React.Fragment>
            <Box as="footer" display="flex" alignItems="center" justifyContent="center" backgroundColor="#A82D49" h="270px" w="full" color="white" >
                <Stack direction="column" gridGap="30px">
                    <Center gridGap="30px">
                        {
                            footerNav.map((e) => <Text as="span" key={Math.random()} fontFamily="'Nunito', sans-serif" fontSize="18px" >
                                {e}
                            </Text>)
                        }
                    </Center>
                    <Center gridGap="14px" >
                        {
                            socialNetworks.map(e => <Link href={e.url} key={Math.random()} pl={e.pl} pt={e.pt} isExternal display="flex" w="20px" h="20px" title={e.socialNetwork}>{parse(e.iconSvg)}</Link>)
                        }
                    </Center>
